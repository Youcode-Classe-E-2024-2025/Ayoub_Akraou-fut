export default function (player) {
	return `<li onclick="choosePlayer(event)" class="player flex justify-between items-center gap-2 p-2 border-b border-gray-500 relative cursor-pointer hover:bg-gray-400 transition-colors active:scale-95" id="${player.id}">
				<div class="options absolute top-0.5 right-0.5 leading-[0]">
					<i
				...
				<img class="avatar max-w-8 xs:max-w-10 aspect-square object-cover" src="${player.photo}" alt="" />
